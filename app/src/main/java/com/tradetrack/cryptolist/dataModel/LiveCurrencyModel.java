...
@Entity(tableName = "selected_currency_table")
public class LiveCurrencyModel {
    ...
    public LiveCurrencyModel(String currencyFullName, String currencyShortcut, String currencyLiveRate, String currencyMaxRate, String currencyIcon, boolean isChecked, boolean isBookMarked) {
